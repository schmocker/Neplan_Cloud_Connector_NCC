...
namespace NeplanWebservices4
{
    public class Class1
    {
        public static NeplanService.NeplanServiceClient nepService = new NeplanService.NeplanServiceClient();
    }
}
...
{
    public NeplanService.NeplanServiceClient nepService;
    public NeplanService.ExternalProject ext;
    ...
    public Webservice()
    {
        nepService = new NeplanService.NeplanServiceClient();                                 //instantiates the neplaservice
